...
import { Globe, Star, Landmark, Search, X, UserCheck } from "lucide-react";
...
export default function LeadershipPage() {
  ...
  const categories = ["All", "Executive Board", "DRRs", "Committee Members"];
      ...
      <main id="main-content">
        ...
        <section className="sticky top-20 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200/80 py-4 px-5 sm:px-6 lg:px-8 shadow-xs">
          <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex w-full md:w-auto overflow-x-auto items-center gap-1.5 pb-1 md:pb-0 [&::-webkit-scrollbar]:hidden">
              {categories.map((cat) => (
                <button
                  key={cat}
          ...
          {searchQuery && (
            <div className="mx-auto max-w-7xl mt-2.5 text-xs text-slate-500 font-medium">
        ...
        {(selectedCategory === "All" || selectedCategory === "Executive Board") && (
        ...
        {/* DRRs Section */}
        {(selectedCategory === "All" || selectedCategory === "DRRs") && (
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-10 gap-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 max-w-2xl">
                    Official DRRs leading member districts across South Asia (RI Zones 4, 5, 6, and 7) for RY 2026–27.
                  </p>
                </div>
        ...
        {/* Committee Section */}
        {(selectedCategory === "All" || selectedCategory === "Committee Members") && (
